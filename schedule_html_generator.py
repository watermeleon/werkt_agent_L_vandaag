    ...
    <style>
        * {{
        ...
        .theme-light .upload-link {{
            background: transparent; border-color: #ced4da; color: #868e96;
            border-radius: 4px;
        }}
        .theme-light .upload-link:hover {{ color: #5568d3; border-color: #5568d3; box-shadow: none; }}
...
<body>
    <div class="container">
        ...
        <div class="footer-row">
            ...
            <a class="upload-link" href="https://raspberrypi.tail6c9a7c.ts.net" target="_blank" rel="noopener"><span class="icon">📤</span> upload pdf</a>
        </div>
    </div>
